...
class ModuleInstanceController extends Controller
{
    ...
    public function show(Activity $activity, ModuleInstance $moduleInstance)
    {
        ...
        return view('management.module_instances.show')->with('moduleInstance', $moduleInstance->load(['actionInstances', 'completionConditionInstance']));
    }

    public function create(Activity $activity)
    {
        return view('management.module_instances.create')->with(['activity' => $activity]);
    }
