...
Route::middleware(['portal-auth'])->group(function () {
    ...
    Route::middleware(['can:view-management'])->group(function () {
        ...
        Route::post('module-instance-setting/many', [\App\Http\Controllers\Api\ModuleInstanceSettingController::class, 'updateMany']);
        ...
        Route::prefix('/module-instance/{module_instance_id}')->group(function () {
            ...
            Route::put('module-instance-services/many', [\App\Http\Controllers\Api\Relationships\ModuleInstanceModuleInstanceServiceController::class, 'updateMany']);
