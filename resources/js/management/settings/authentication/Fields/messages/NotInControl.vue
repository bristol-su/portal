...
<script>
    export default {
        ...
        mounted() {
            this.$api.settings().get(window.settingKeys.authentication.messages.notInControl, null)
        ...
        methods: {
            updateAttribute: _.debounce(function(message) {
                ...
                if(message !== this.currentMessage) {
                    ...
                    this.$api.settings().set(window.settingKeys.authentication.messages.notInControl, message)
