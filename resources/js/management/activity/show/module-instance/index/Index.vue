<template>
    <div>
        <div class="flex justify-end gap-2 self-end mb-2">
            <span>Actions: </span>
            <a :href="$tools.routes.basic.baseWebUrl() + '/activity/' + activity.id + '/module-instance/create'" class="text-primary hover:text-primary-dark">
...
<!--                                    <a @click.prevent="deleteModule(module.id)"><b-button variant="danger" v-if="canDelete">Delete</b-button></a>-->
<!--                                </b-td>-->
<!--                            </b-tr>-->
<!--                        </b-tbody>-->
<!--                    </b-table-simple>-->
